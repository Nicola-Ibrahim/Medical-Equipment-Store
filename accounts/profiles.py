...
class BaseAccountantProfile(models.Model):
    base_accountant = models.OneToOneField(
        BaseAccountant, related_name='base_accountant_profile', on_delete=models.CASCADE)
...
class DeliveryWorkerAccountantProfile(models.Model):
    delivery_worker_accountant = models.OneToOneField(
        DeliveryWorkerAccountant, related_name='delivery_worker_accountant_profile', on_delete=models.CASCADE)
    first_name = models.CharField(max_length=200)
    last_name = models.CharField(max_length=200)
...
class WarehouseAccountantProfile(models.Model):
    warehouse_accountant = models.OneToOneField(
        WarehouseAccountant, related_name='warehouse_accountant_profile', on_delete=models.CASCADE)
    first_name = models.CharField(max_length=200)
    last_name = models.CharField(max_length=200)
...
class StatisticianProfile(models.Model):
    statistician = models.OneToOneField(
        Statistician, related_name='statistician_profile', on_delete=models.CASCADE)
    first_name = models.CharField(max_length=200)
    last_name = models.CharField(max_length=200)
...
class WarehouseProfile(models.Model):
    warehouse = models.OneToOneField(
        Warehouse, related_name='warehouse_profile', on_delete=models.CASCADE, blank=True, null=True)
...
class Section(models.Model):
    ...
    warehouse = models.ManyToManyField(
        WarehouseProfile, related_name='sections')
...
class Service(models.Model):
    name = models.CharField(max_length=200)
    Warehouse = models.ManyToManyField(
        WarehouseProfile, related_name='services')
...
class DeliveryWorkerProfile(models.Model):
    delivery_worker = models.OneToOneField(
        DeliveryWorker, related_name='delivery_worker_profile', on_delete=models.CASCADE, blank=True, null=True)
    first_name = models.CharField(max_length=200)
    last_name = models.CharField(max_length=200)
...
class DoctorProfile(models.Model):
    doctor = models.OneToOneField(
        Doctor, related_name='doctor_profile', on_delete=models.CASCADE, blank=True, null=True)
    first_name = models.CharField(max_length=200)
    last_name = models.CharField(max_length=200)
