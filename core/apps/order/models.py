...
from core.apps.accounts.models import DeliveryWorker, Doctor
from core.apps.product.models import Product
...
class Order(models.Model):
    ...
    delivery_worker = models.ForeignKey(
        DeliveryWorker, related_name="delivery_worker_orders", on_delete=models.SET_NULL, null=True
    )
